...
export const OnboardingPage: React.FC = () => {
    ...
    const handleNextStepSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        goToNextStep();
    };
                ...
                {step === 1 ? (
                    <>
                        ...
                        <section className="w-full max-w-2xl bg-surface-container-lowest shadow-2xl rounded-xl overflow-hidden flex flex-col border border-outline-variant/10 relative z-10">
                            ...
                            {/* Form Content */}
                            <div className="px-10 py-10 grow">
                                <div className="max-w-xl mx-auto">
                                    ...
                                    <form className="space-y-8" id="company-form" onSubmit={handleNextStepSubmit}>
                                        {/* Field 1 */}
                                        <div className="group">
                                            ...
                                            <input
                                                required
                                                className="w-full px-5 py-4 bg-surface-container-low border-none rounded-xl text-lg font-body focus:ring-4 focus:ring-primary-fixed focus:bg-surface-container-lowest transition-all placeholder:text-outline-variant text-on-surface"
                                                placeholder="Ej: Gym Fitness S.A.S"
                                                type="text"
                                                value={razonSocial}
                    ...
                    <>
                        ...
                        <section className="w-full max-w-2xl bg-surface-container-lowest rounded-xl p-8 md:p-12 shadow-sm shadow-slate-200/50 relative z-10">
                            ...
                            <form className="space-y-8" onSubmit={handleCompleteSubmit}>
                                <div className="grid grid-cols-1 gap-6">
                                    ...
                                    <div className="group">
                                        ...
                                        <input
                                            required
                                            className="w-full h-14 px-6 rounded-xl border-0 bg-surface-container-low text-on-surface placeholder:text-outline focus:ring-2 focus:ring-primary-fixed focus:bg-surface-container-lowest transition-all duration-200 font-body"
                                    ...
                                    <div className="group">
                                        ...
                                        <div className="relative">
                                            <input
                                                required
                                                className="w-full h-14 pl-12 pr-6 rounded-xl border-0 bg-surface-container-low text-on-surface placeholder:text-outline focus:ring-2 focus:ring-primary-fixed focus:bg-surface-container-lowest transition-all duration-200 font-body"
                                ...
                                <div className="w-full h-48 rounded-xl overflow-hidden mt-8 relative group">
                                    <img
                                        alt="Gym interior"
                                        className="w-full h-full object-cover grayscale opacity-20 group-hover:opacity-30 transition-opacity duration-500"
                                        src="https://lh3.googleusercontent.com/aida-public/AB6AXuDH68GK84Fowi69LxlN5bMZlToqqtOsOFoKXL01QS6eHhxE6RcTU3Fr0pZFHC5fxpGt2rgDeSFyPdFAjKMe7ty5ovcj6nEK6IjKzSOjUovZKwGkH3DKZklSsdCsrZG2lM5_xqWjFLrrAxESG8NLo1Tv4XRaxcpzUFAgb3a4vvzcW_su2M2KUzVv4SHykHIFW8VkzX2efTxemn6l8npDNDdZ6zsCc4JI1x0UQLQ3kKGv4uF1Dt_5R27xqGAldFPsQy54Y6OG-exA95Wr"
                                    />
